...
if __name__ == "__main__":
    ...
    if mixture:
        if infos['selection_parameters']: error_trap("Selection Function currently not enabled with mixture model!")
    ...
    if args.SIMULATE:
        ...
        if infos['Skysurvey']:
            ...
            if (np.mean(dfdata.MURES) - np.mean(df.MURES)) > 5:
                print("MURES Distributions have different ZP; Aborting...") ; quit()
